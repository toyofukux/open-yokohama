...
import { policyIssues as issues } from '../../../packages/core/policy-issues';
...
export function createServer() {
  ...
  server.registerResource(
    ...
    {
      description:
        'Published policy article metadata and website URL. No independent review claim.',
        ...
        contents: [
          {
            ...
            text: JSON.stringify({
              issue,
              url: `https://open.yokohama${issue.url}`,
            }),
          },
        ],
      };
